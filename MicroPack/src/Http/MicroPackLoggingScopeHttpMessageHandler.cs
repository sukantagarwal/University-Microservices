...
{
    internal sealed class MicroPackLoggingScopeHttpMessageHandler : DelegatingHandler
    {
        private readonly ILogger _logger;
        private readonly HashSet<string> _maskedRequestUrlParts;
        private readonly string _maskTemplate;

        public MicroPackLoggingScopeHttpMessageHandler(ILogger logger, HttpClientOptions options)
        {
